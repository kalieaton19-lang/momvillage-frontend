  ...
  return (
    <div>
      <div className="flex gap-2 mb-4 justify-center">
        <input
          type="text"
          className="px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-pink-500 w-3/4 max-w-3xl"
                    ...
                    {conversations.map((conv) => {
                      ...
                      return (
                        <button
                          key={conv.id}
                          className={
                            `flex items-center gap-2 p-2 rounded-lg border max-w-3xl w-3/4 mx-auto transition-all focus:outline-none focus:ring-1 focus:ring-pink-400 ` +
