            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
              <div className="bg-white dark:bg-zinc-900 rounded-2xl p-8 max-w-sm w-full shadow-xl relative">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-4">
                    <span className={`px-4 py-2 rounded-lg text-base ${selectedInvitation.status === "pending" ? "bg-yellow-100 text-yellow-800" : selectedInvitation.status === "accepted" ? "bg-green-100 text-green-700" : selectedInvitation.status === "declined" ? "bg-zinc-200 text-zinc-700" : "bg-zinc-100 text-zinc-700"}`}>{selectedInvitation.status}</span>
                  </div>
                </div>
              </div>
            </div>
