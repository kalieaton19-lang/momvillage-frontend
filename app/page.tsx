      ...
      <div className="w-full max-w-[900px] aspect-square relative">
        <svg viewBox="0 0 900 900" className="w-full h-full">
          <g
            style={{
              opacity: phase >= 1 ? 1 : 0,
              transform: `translateX(${phase >= 3 ? -70 : phase >= 2 ? -145 : 0}px) translateY(${phase >= 3 ? -120 : phase >= 2 ? 25 : 0}px) scale(${phase >= 3 ? 0.72 : phase >= 2 ? 0.82 : 1})`,
          ...
          <g
            style={{
              opacity: phase >= 1 ? 1 : 0,
              transform: `translateX(${phase >= 3 ? -70 : phase >= 2 ? -145 : 0}px) translateY(${phase >= 3 ? 190 : phase >= 2 ? 25 : 0}px) rotate(${phase >= 3 ? 180 : 0}deg) scale(${phase >= 3 ? 0.72 : phase >= 2 ? 0.82 : 1})`,
              transformOrigin: "center",
              transition: "opacity 900ms ease, transform 1300ms ease-in-out",
            }}
          >
