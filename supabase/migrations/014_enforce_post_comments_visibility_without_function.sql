-- Migration: Remove function-based comment visibility and enforce deterministic RLS.
-- This avoids refresh-time inconsistencies caused by can_view_post(post_id).
